...
namespace ResultOrError.Partials
{
    public static partial class ResultOrErrorExtension
    {
        ...
        public static async Task<ResultOrError<TValue>> FailIf<TValue>(
            this Task<ResultOrError<TValue>> errorOr,
        ...
        /// <typeparam name="TValue">The type of the underlying value in the <paramref name="errorOr"/>.</typeparam>
        /// <returns>The given <paramref name="error"/> if <paramref name="onValue"/> returns true; otherwise, the original <see cref="ErrorOr"/> instance.</returns>
        public static async Task<ResultOrError<TValue>> FailIfAsync<TValue>(
            this Task<ResultOrError<TValue>> errorOr,
