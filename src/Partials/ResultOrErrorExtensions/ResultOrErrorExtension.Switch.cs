...
namespace ResultOrError.Partials
{
    public static partial class ResultOrErrorExtension
    {
        ...
        public static async Task Switch<TValue>(this Task<ResultOrError<TValue>> errorOr, Action<TValue> onValue, Action<List<Error>> onError)
        {
        ...
        /// <param name="onError">The action to execute if the state is an error.</param>
        /// <returns>The result of the executed function.</returns>
        public static async Task SwitchAsync<TValue>(this Task<ResultOrError<TValue>> errorOr, Func<TValue, Task> onValue, Func<List<Error>, Task> onError)
        {
            var result = await errorOr.ConfigureAwait(false);
        ...
        /// <param name="onError">The action to execute if the state is an error.</param>
        /// <returns>The result of the executed function.</returns>
        public static async Task SwitchFirst<TValue>(this Task<ResultOrError<TValue>> errorOr, Action<TValue> onValue, Action<Error> onError)
        {
            var result = await errorOr.ConfigureAwait(false);
        ...
        /// <param name="onError">The action to execute if the state is an error.</param>
        /// <returns>The result of the executed function.</returns>
        public static async Task SwitchFirstAsync<TValue>(this Task<ResultOrError<TValue>> errorOr, Func<TValue, Task> onValue, Func<Error, Task> onError)
        {
            var result = await errorOr.ConfigureAwait(false);
