...
public sealed class ErrorOrEqualityTests
{
    ...
    public void Equals_WhenTwoInstancesHaveTheSameErrorsCollection_ShouldReturnTrue()
    {
        ...
        ResultOrError<Person> errorOrPerson1 = errors;
        ResultOrError<Person> errorOrPerson2 = errors;
    ...
    public void Equals_WhenTwoInstancesHaveDifferentErrorCollectionsWithSameErrors_ShouldReturnTrue()
    {
        ...
        ResultOrError<Person> errorOrPerson1 = errors1;
        ResultOrError<Person> errorOrPerson2 = errors2;
    ...
    {
        ResultOrError<Person> errorOrPerson1 = new Person(name);
        ResultOrError<Person> errorOrPerson2 = new Person(name);
    ...
    {
        ResultOrError<Person> errorOrPerson1 = new Person(name1);
        ResultOrError<Person> errorOrPerson2 = new Person(name2);
